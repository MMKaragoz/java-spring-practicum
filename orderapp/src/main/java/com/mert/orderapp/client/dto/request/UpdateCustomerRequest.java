...
public class UpdateCustomerRequest {
	...
	public UpdateCustomerRequest(@NotBlank(message = "Name is required.") @Size(min = 2, max = 100) String name,
	...
	public String toString() {
		return "UpdateCustomerRequest [name=" + name + ", surname=" + surname + ", companyId=" + companyId + "]";
	}
